    ...
    implements IInterceptable<IObjectWillChange>, IListenable
{
    ...
    constructor(
        ...
        this.keysAtom_ = new Atom(window.__DEV__ ? `${this.name_}.keys` : 'ObservableObject.keys');
    ...
    has_(key: PropertyKey): boolean {
        ...
        if (!entry) {
            entry = new ObservableValue(
                key in this.target_,
                referenceEnhancer,
                window.__DEV__ ? `${this.name_}.${stringifyKey(key)}?` : 'ObservableObject.key?',
                false
            );
    ...
    defineObservableProperty_(
        ...
        try {
            ...
            const observable = new ObservableValue(
                value,
                enhancer,
                window.__DEV__ ? `${this.name_}.${key.toString()}` : 'ObservableObject.key',
                false
            );
