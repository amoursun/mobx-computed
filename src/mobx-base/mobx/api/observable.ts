...
// const log = require("../tool/index/fs.js");
// const logger = log('_observable', 1, true);
...
function createObservable(v: any, arg2?: any, arg3?: any) {
    ...
    console.log('createObservable', '参数1：v', v, '参数2：',arg2,'参数3：', arg3, 'isStringish(arg2)',isStringish(arg2))
    // @observable someProp;
    if (isStringish(arg2)) {
...
const observableFactories: IObservableFactory = {
    ...
    object<T = any>(
        ...
        const o = asCreateObservableOptions(options)
        const base = {}
        // 这里在options.deep是false的时候其实使用的referenceEnhancer这个enhancer
